...
int main()
{
    ...
    shared_ptr<solid_color> point5col = make_shared<solid_color>(0.2, 0.5,0.5);
    shared_ptr<solid_color> point1col = make_shared<solid_color>(0.01, 0.5,0.5);
    ...
    //add objects
    objects.add(make_shared<sphere>(point3(0.25,0.0,-0.75), 0.2, glassy));
    ...
    //lights.add(light);
    //lights.add()
    objects.add(make_shared<mesh>("c_white.obj", transform, size, spec));
    objects.add(make_shared<mesh>("c_green.obj", transform, size, green));
    objects.add(make_shared<mesh>("c_red.obj", transform, size, redmet));
